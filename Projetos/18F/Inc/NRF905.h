...
#define nRfAt422_4MHz  0x00
#define nRfAt422_5MHz  0x01
#define nRfAt425_0MHz  0x1A
#define nRfAt427_5MHz  0x33

#define nRfAt430_0MHz  0x4C
#define nRfAt433_0MHz  0x6A
#define nRfAt433_1MHz  0x6B
#define nRfAt433_2MHz  0x6C
#define nRfAt434_7MHz  0x7B
#define nRfAt473_5MHz  0x1FF

#define nRfAt844_8MHz  0x00

#define nRfAt862_0MHz  0x56
#define nRfAt868_0MHz  0x74
#define nRfAt868_2MHz  0x75
#define nRfAt868_4MHz  0x76
#define nRfAt869_8MHz  0x7d
#define nRfAt895_8MHz  0xFF
...
#define TX_AFW_1BYTE         (0x01 << 4)                     //1        Byte2.7~4
#define TX_AFW_2BYTE         (0x02 << 4)                      //2        Byte2.7~4
#define TX_AFW_3BYTE         (0x03 << 4)                      //3        Byte2.7~4
#define TX_AFW_4BYTE         (0x04 << 4)                      //4        Byte2.7~4   100
...
typedef enum
{
	eWcRegister  = 0x00, /*Write Configuration Registers*/
	eWcRegister1 = 0x01,
	eWcRegister2 = 0x02,
	eWcRegister3 = 0x03,
	eWcRegister4 = 0x04,
	...
	eRcRegister  = 0x10, /*Read Configuration Registers*/
	eRcRegister1 = 0x11,
	eRcRegister2 = 0x12,
	eRcRegister3 = 0x13,
	eRcRegister4 = 0x14,
	...
	eWtpRegister = 0x20, /*Write TX Payload*/
	eRtpRegister = 0x21, /*Read TX Payload*/

	eWtaRegister = 0x22, /*Write TX Address*/
	eRtaRegister = 0x23, /*Read TX Address*/

	eRrpRegister = 0x24, /*Read RX Payload*/
	eCnlRegister = 0x80  /*Channel config cc*/
}nRF905CommandsType;


HAL_StatusTypeDef nRf905SetConfig(void);
HAL_StatusTypeDef nRf905CheckConfig(void);
