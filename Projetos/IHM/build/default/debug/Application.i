...
# 12 "./WS0010.h" 2
# 47 "./WS0010.h"
extern uint8_t Ws0010_buffer[200];
...
static ProcessStruct ProcessVector[3U];
...
void ProcessPeriodic(void)
{
    ...
    uint8_t *pf;
    static uint8_t StrCommand[9U * 5U];
...
void PrintData(uint8_t* StrTemp, uint8_t* StrRH)
{
    ...
    Ws0010BufGotoXY(45, 1);
    Ws0010Buf5x7Char('o', 0);
    Ws0010BufGotoXY(45, 2);
